...
class SolutionAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Complementary information',   {'fields':['seed', 'i_dmin', 'i_dmax', 'idec_2', 'idec_3', 'gfdir', 'twptt', 'p2p_fac_min', 'p2p_fac_max', 'tr_length_global', 'tr_length_regional', 'tr_dlat', 'tr_dlon', 'tr_opdffile', 'tr_ylimauto', 'tr_ylimfixed', 'tr_nc', 'tr_nl']}),
